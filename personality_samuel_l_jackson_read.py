"""
personality_samuel_l_jackson_read — retrieve personality data across all four stores.
...
@register_tool
class PersonalitySamuelLJacksonReadTool(BaseTool):
    """Load Samuel L. Jackson personality traits, quotes, lexicon, and reactions."""

    @property
    def name(self) -> str:
        return "personality_samuel_l_jackson_read"

    @property
    def description(self) -> str:
        return (
            "Load Samuel L. Jackson personality data for the given categories. "
    ...
    async def execute(
        ...
        **kwargs,
        ...
        log.info("personality_samuel_l_jackson_read",
        ...
        try:
            ...
            try:
                ...
                await log_tool_activity(
                    tool_name="personality_samuel_l_jackson_read",
            ...
            log.error("personality_samuel_l_jackson_read_error", error=str(e))
